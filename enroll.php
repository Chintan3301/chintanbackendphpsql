...
<body>
    ...
    <section class="home-section">
            ...
            <table class="table ">
                <thead>
                    ...
                    <tr>
                        ...
                        <th class="text-center">Date of Enrolled</th>
                ...
                $sql = "SELECT `enrollment_id`, `student_id`, `class_id`, `date_enrolled` FROM `enrollment`";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td><a href="enrolledit.php" class="btn btn-primary" style="height:40px">Edit</a></td>

                            <td><a href="enrolldel.php" class="btn btn-danger" style="height:40px">Delete</a></td>
        ...
        <a href="enrolladd.php">
            <button class="block"><b>Add Enrollment Information</b></button>
        </a>
