...
<body>
    ...
    <section class="home-section">
            ...
            <table class="table ">
                <thead>
                    ...
                    <tr>
                        ...
                        <th class="text-center">Class Name Name</th>
                ...
                $sql = "SELECT `class_id`, `class_name`, `teacher_id` FROM `class`";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td><a href="classedit.php" class="btn btn-primary" style="height:40px">Edit</a></td>

                            <td><a href="classdel.php" class="btn btn-danger" style="height:40px">Delete</a></td>
        ...
        <a href="classadd.php">
            <button class="block"><b>Add Class</b></button>
        </a>
