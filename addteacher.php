        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <form action="codeaddteacher.php" method="POST">
                            <div class="row">
                            <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        <label for="">teacher Id</label>
                                        <input type="text" name="teacher_id" class="form-control" required placeholder="Enter student id">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="last_name" class="form-control" required placeholder="Enter your Name">
                                    </div>
                                </div>                         
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
